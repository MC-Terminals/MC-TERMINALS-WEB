...
const empresasUnicas = [...new Set(usuariosData.map(u => u.empresa))].sort();
...
const fecha = new Date(o.fecha_generada).toLocaleDateString('fr-CA');
  ...
  (!empresa || (empresasPorNit[o.nit_usuario] || "").toLowerCase().includes(empresa))
);
  });
...
[filtroEstatus, filtroInicio, filtroFin, filtroBodega, filtroProducto, filtroPlaca, filtroPiloto, filtroEmpresa]
